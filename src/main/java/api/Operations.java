...
import exceptions.FaultData;
import util.HttpUtil;
import util.JsonMapper;

import java.util.*;

import static enums.ApiNgOperation.*;
import static enums.Endpoint.ACCOUNT;
import static enums.Endpoint.BETTING;
...
public final class Operations {
    ...
    public static final ObjectMapper om = new JsonMapper();
    ...
    public UpdateExecutionReport updateOrders(
            ...
            String customerRef) throws ApiNgException, JsonProcessingException {
