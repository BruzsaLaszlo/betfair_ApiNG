...
public class ApiNgException extends RuntimeException {
     ...
     * <p>
     * NO_APP_KEY
     * An aping.application key header ('X-Application') has not been provided in the request.
     * <p>
     * NO_SESSION
     ...
     * <p>
     * INVALID_APP_KEY
     * The aping.application key passed is invalid or is not present
     * <p>
     * TOO_MANY_REQUESTS
    ...
    public void printStackTrace() {
        ...
        System.out.println("APINGException" + '\n' +
