...
public enum ErrorCode {
    ...
    NO_APP_KEY("An aping.application key header ('X-Application') has not been provided in the request."),
    ...
    INVALID_APP_KEY("The aping.application key passed is invalid or is not present"),

    TOO_MANY_REQUESTS("There are too many pending (in-flght) requests e.g. a listMarketBook with Order/Match projections is limited to 3 concurrent requests. The error also applies to: " +
