...
import static aping.enums.ApiNgOperation.*;
import static aping.enums.Endpoint.ACCOUNT;
import static aping.enums.Endpoint.BETTING;
...
public final class Operations {
    ...
    public List<EventTypeResult> listEventTypes(MarketFilter filter) throws ApiNgException {
        ...
        return jsonMapper.readValue(result, new TypeReference<>() {
        });
    }
     ...
     */
    public List<MarketBook> listMarketBook(MarketBookParameters mbp) throws ApiNgException {
    ...
    public ReplaceExecutionReport replaceOrders(String marketId, List<ReplaceInstruction> instructions, String customerRef)
        ...
        return jsonMapper.readValue(result, ReplaceExecutionReport.class);
    }
    ...
    public UpdateExecutionReport updateOrders(
        ...
        return jsonMapper.readValue(result, UpdateExecutionReport.class);
    }
     ...
     */
    public CurrentOrderSummaryReport listCurrentOrders(CurrentOrdersParameters cop) throws ApiNgException {
        var params = new HashMap<String, Object>();
        ...
        return jsonMapper.readValue(result, CurrentOrderSummaryReport.class);
    }
     ...
     */
    public ClearedOrderSummaryReport listClearedOrders(ClearedOrderSummaryParameters cosp) throws ApiNgException {
        var params = new HashMap<String, Object>();
        ...
        return jsonMapper.readValue(result, ClearedOrderSummaryReport.class);
    }
    ...
    private String makeRequestBetting(ApiNgOperation operation, Map<String, Object> params) throws ApiNgException {
        return makeRequest(operation, params, BETTING);
    }

    private String makeRequestAccount(ApiNgOperation operation) throws ApiNgException {
        return makeRequest(operation, Collections.emptyMap(), ACCOUNT);
    }

    private String makeRequestHeartbeat(Map<String, Object> params) throws ApiNgException {
        return makeRequest(ApiNgOperation.HEARTBEAT, params, Endpoint.HEARTBEAT);
    }

    private String makeRequest(ApiNgOperation operation, Map<String, Object> params, Endpoint endpoint) throws ApiNgException {

        params = params.entrySet().stream()
                .filter(stringObjectEntry -> stringObjectEntry.getValue() != null)
                .collect(toUnmodifiableMap(Map.Entry::getKey, Map.Entry::getValue));
        String requestString = jsonMapper.writeValueAsString(params);
        ...
        try {
            ...
            FaultData faultData = jsonMapper.readValue(exception.getMessage(), FaultData.class);
            if (faultData == null || faultData.apiNgException() == null)
                throw new IllegalStateException("komoly hiba nics ApiNgException sem! faultString: " + faultData.faultstring());
            else
                throw faultData.apiNgException();
        }
    }

    /**
     * Create 2 aping.application keys for given user; one active and the other
     * delayed
     *
     * @param appName A Display name for the aping.application.
     * @return DeveloperApp A map of aping.application keys, one marked ACTIVE, and
     * the other DELAYED
     */
    public DeveloperApp createDeveloperAppKeys(String appName) throws ApiNgException {
        ...
        return jsonMapper.readValue(response, DeveloperApp.class);
    }

    /**
     * Get all aping.application keys owned by the given developer/vendor
     *
     * @return List<DeveloperApp> A list of aping.application keys owned by the given developer/vendor
     */
    ...
    public AccountFundsResponse getAccountFunds() throws ApiNgException {
        ...
        return jsonMapper.readValue(response, AccountFundsResponse.class);
    }
    ...
    public AccountDetailsResponse getAccountDetails() throws ApiNgException {
        ...
        return jsonMapper.readValue(response, AccountDetailsResponse.class);
    }
    ...
    public HeartbeatReport heartbeat(int preferredTimeoutSeconds) throws ApiNgException {
        ...
        return jsonMapper.readValue(response, HeartbeatReport.class);
    }
