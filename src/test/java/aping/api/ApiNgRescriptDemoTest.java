...
class ApiNgRescriptDemoTest {
    ...
    void start() {
        ...
        List<EventTypeResult> r = operations.listEventTypes(MarketFilter.empty());
        ...
        List<MarketCatalogue> marketCatalogueResult =
                operations.listMarketCatalogue(marketFilter, marketProjection, MarketSort.FIRST_TO_START, maxResults);
        ...
        var params = MarketBookParameters.builder()
                .marketIds(marketIds)
                .build();
        List<MarketBook> marketBookReturn = operations.listMarketBook(params);
        ...
        if (!marketBookReturn.isEmpty()) {
            ...
            PlaceExecutionReport placeBetResult = operations.placeOrders(marketIdChosen, instructions, customerRef);
